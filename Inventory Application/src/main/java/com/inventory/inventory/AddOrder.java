...
public class AddOrder {
    ...
    public void onAdd() {
        ...
        try{
            String insertQueryOrder = "INSERT INTO inventorydatabase.Order VALUES("+ id + ", '" + date.getText() + "', " + customerID + ", " + 1 + ")";
            String insertQueryOrderLine = "INSERT INTO inventorydatabase.Order_Line VALUES(" + id + ", " + prodID+ ", " + quantity.getText() +")";
